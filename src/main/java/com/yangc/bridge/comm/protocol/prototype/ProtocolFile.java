 ...
 * @功能: 0x68 [contentType(0x04)] [uuid] [fromLength] [toLength] [dataLength] [from] [to] 0x68 [transmitStatus] [fileNameLength] [fileName] [fileSize] [fileMd5] [offset] [data] [crc] 0x16
 * @作者: yangc
...
public class ProtocolFile extends Protocol {
	...
	private byte transmitStatus; // 1byte
